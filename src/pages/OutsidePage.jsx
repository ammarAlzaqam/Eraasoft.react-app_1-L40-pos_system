...
export default function OutsidePage() {
  ...
  return (
    <div className="container mx-auto flex-col-reverse md:flex-row flex gap-8">
      <div className="flex flex-col gap-3 w-full">
        <h2 className="text-xl text-primary-500 font-semibold">
          Under Process Orders
        </h2>
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-4 animate__animated animate__fadeIn animate__fast">
          {orders
            .filter((or) => or.order_status === "Under Process")
            .map((or) => (
      ...
      <div className="flex flex-col gap-3 w-full">
        <h2 className="text-xl text-primary-500 font-semibold">Ready Orders</h2>
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-4 animate__animated animate__fadeIn animate__fast">
          {orders
            .filter((or) => or.order_status === "Ready")
            .map((or) => (
              <div key={or.documentId} className="card bg-base-100 shadow-sm">
                <div className="card-body flex flex-col justify-between">
                  <div className="flex flex-col gap-3">
                  ...
                  <div className="mt-6">
                    <button
                      className="btn"
                      onClick={() => makeOrderDelivered(or.documentId)}
                    >
                      Order Delivered
                    </button>
                  </div>
